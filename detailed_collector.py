...
class DetailedCollector(Collector):
    ...
    def collect(
        ...
        episode_states = defaultdict(list) ###ADDED
        ...
        while True:
            ...
            for information in info:
                if "player_index" in information:
                    episode_states[information["player_index"]].append(information) ### Added
                    # print(information)

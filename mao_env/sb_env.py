...
class SB3ActionMaskWrapper(pettingzoo.utils.BaseWrapper):
    ...
    def observe(self, agent):
        ...
        return super().observe(agent)["observation"][0]
...
def mask_fn(env):
    ...
    return env.game.get_observation(env.game.turn)["action_mask"]
...
def eval_action_mask(env_fn, num_games=100, render_mode=None, **env_kwargs):
    ...
    for i in range(num_games):
        ...
        for agent in env.agent_iter():
            ...
            action_mask, observation = obs.values()
...
if __name__ == "__main__":
    ...
    env_kwargs = {"config":Config(4,["Alpha","Beta","Gamma","Delta"],52)}
